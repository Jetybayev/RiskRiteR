...
class LogicState:
    ...
    START_CUSTOM_SETTINGS = 'START_CUSTOM_SETTINGS'
    KEYBOARD_SHORTCUTS = 'KEYBOARD_SHORTCUTS'
    COMPLETION_CUSTOM_SETTINGS = 'COMPLETION_CUSTOM_SETTINGS'
    CUSTOM_WINDOWS_STATION = 'CUSTOM_WINDOWS_STATION'
    SCAN_UNNECESSARY_MENU_DOCK = 'SCAN_UNNECESSARY_MENU_DOCK'
    CLOSING_UNNECESSARY_MENU_DOCK = 'CLOSING_UNNECESSARY_MENU_DOCK'
    SCAN_UNNECESSARY_MENU_SPACE = 'SCAN_UNNECESSARY_MENU_SPACE'
    CLOSING_UNNECESSARY_MENU_SPACE = 'CLOSING_UNNECESSARY_MENU_SPACE'
    CUSTOM_OVERVIEW = 'CUSTOM_OVERVIEW'
    CUSTOM_WINDOWS_SPACE = 'CUSTOM_WINDOWS_SPACE'
    SCAN_ADDITIONAL_UNNECESSARY_MENU_SPACE = 'SCAN_ADDITIONAL_UNNECESSARY_MENU_SPACE'
    CLOSING_ADDITIONAL_UNNECESSARY_MENU_SPACE = 'CLOSING_ADDITIONAL_UNNECESSARY_MENU_SPACE'
    SCAN_ADDITIONAL_UNNECESSARY_MENU_DOCK = 'SCAN_ADDITIONAL_UNNECESSARY_MENU_DOCK'
    COMPLETION_CUSTOM_WINDOWS = 'COMPLETION_CUSTOM_WINDOWS'
    STOP = 'STOP'
